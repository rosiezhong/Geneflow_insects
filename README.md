...
## split.sh
To account for translocation, differences in genome positions etc., the chromosomal copy of the second species is split before aligning it with the reference genome(chromosomal copy of species 1). Split.sh can be run as follows
```
